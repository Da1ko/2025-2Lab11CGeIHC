...
// average normals
	...
	GLfloat octaedro_vertices[] = {
		...
		//X		Y		Z		S		T		NX		NY		NZ
		//1
		0.0f,  1.0f,  0.0f,    0.49f, 0.73f,   0.0f,  1.0f,  1.0f,  //Pico superior
...
int main()
{
	...
	dadoTexture = Texture("Textures/dadoEscalado.jpg");
	...
	Dado_M = Model();
	Dado_M.LoadModel("Models/cuboAnimalesTexturizado.obj");
	coche = Model();
