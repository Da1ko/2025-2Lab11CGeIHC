...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//meshList[0]->RenderMesh(); //dibuja cubo 0 y pirámide triangular
		//meshList[2]->RenderMeshGeometry(); //dibuja las figuras geométricas cilindro 2, cono 3, pirámide base cuadrangular 
